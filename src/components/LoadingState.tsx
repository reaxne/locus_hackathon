...
const stages: Record<string, [string, string]> = {
  ...
  budget_exhausted: ['Лимит времени исчерпан', 'Завершаем запрос без запуска слишком короткой попытки.'],
  generation_failed: ['ИИ не ответил', 'Сохраняем предыдущий маршрут и готовим возможность повтора.'],
